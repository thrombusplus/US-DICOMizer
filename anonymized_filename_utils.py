...
DEFAULT_TAG_LABEL_BY_VALUE = {
    "none": "None",
    "CFVr-L": "Common Femoral Vein Random (Left)",
    "CFV-L": "Common Femoral Vein (Left)",
    "CFVr-R": "Common Femoral Vein Random (Right)",
    "CFV-R": "Common Femoral Vein (Right)",
    "GSVr-L": "Great Saphenous Vein Random (Left)",
    "GSV-L": "Great Saphenous Vein (Left)",
    "GSVr-R": "Great Saphenous Vein Random (Right)",
    "GSV-R": "Great Saphenous Vein (Right)",
    "FVr-L": "Femoral Vein Random (Left)",
    "FV-L": "Femoral Vein (Left)",
    "FVr-R": "Femoral Vein Random (Right)",
    "FV-R": "Femoral Vein (Right)",
    "FV-Dr-L": "Distal Femoral Vein Random (Left)",
    "FV-D-L": "Distal Femoral Vein (Left)",
    "FV-Dr-R": "Distal Femoral Vein Random (Right)",
    "FV-D-R": "Distal Femoral Vein (Right)",
    "PVr-L": "Popliteal Vein Random (Left)",
    "PV-L": "Popliteal Vein (Left)",
    "PVr-R": "Popliteal Vein Random (Right)",
